...
app.post('/create-product', async (req, res) => {
  ...
  const {
    ...
    tags,
    product_type,
    collections,       // array of collection handles e.g. ['door-wreaths', 'holiday-and-seasonal']
    weight_lbs,        // packaged weight in pounds (number or null)
    meta_description,  // SEO meta description string
    requires_shipping, // false for outdoor pot local-only pieces
    images
  } = req.body;
