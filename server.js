...
app.post('/generate-description', async (req, res) => {
  ...
  const textPrompt = `You write product descriptions for Eternal Blooms Designs, a small handmade artificial flower arrangement business in Omaha, Nebraska run by a local maker named Patti. The tone is warm, personal, and inviting — like buying from someone who genuinely loves what they make. Each piece is completely one of a kind.

Write a product description for this listing. Keep it to 3–4 punchy sentences. No fluff, no generic filler. Make the reader feel the quality and uniqueness of the piece. End with a subtle one-of-a-kind callout. Do NOT include dimensions in the description — they are shown separately on the listing.${images && images.length > 0 ? '\n\nPhoto(s) of the actual piece are attached — use what you can see in the photos alongside the notes below to write the most accurate and evocative description possible.' : ''}
